          ...
          <div class="header-navbar">
            <nav class="header-menu" id="header-menu">
              <ul class="menu">
                ...
                <li class="menu-item"><a class="menu-link nav-link active" href="/about">About</a></li>
      ...
      <div class="row justify-content-between gutter-vr-30px">
        <div class="col-lg-6">
          <div class="image-block">
            <img src="img/manjakos/<%includes.global.one[0]['who_we_are']['collections']['image_whoweare']%>" alt="">
          </div>
        </div><!-- .col -->
        <div class="col-lg-6">

          <div class="text-block block-pad-b-100">
            <h5 class="heading-xs dash"> <%includes.global.one[0]['who_we_are']['collections']['text_above_title']['en']%></h5>
            <h2><%includes.global.one[0]['who_we_are']['collections']['title_whoweare']['en']%></h2>
            <p class="lead"><%includes.global.one[0]['who_we_are']['collections']['text2_whoweare']['en']%></p>
            <p><%includes.global.one[0]['who_we_are']['collections']['text3_whoweare']['en'] | removeHTMLTags %></p>
          </div><!-- .text-block  -->
        </div><!-- .col -->
      </div><!-- .row -->
    </div><!-- .container -->
  ...
  <div class="section section-x tc-light section-feature-alt">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 bdr-rt bdr_dark_v1 text-center" ng-repeat="box in includes.global.many[0]['what_we_do_boxes']">
              <div class="feature feature-alt">
                ...
                <div class="feature-content">
                  ...
                  <p>
                    <%box['collections']['description']['en'] | removeHTMLTags%>
                  </p>
                 <!--  <a
                    href="texas-services.html"
                    class="btn btn-arrow btn-arrow-light"
                    >Read More</a
                  > -->
                </div>
              </div>
